...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	AT24CXX_Read(0,remoteip,4);
	lwipx->remoteip[0]=remoteip[0];	
	lwipx->remoteip[1]=remoteip[1];
	lwipx->remoteip[2]=remoteip[2];
	lwipx->remoteip[3]=remoteip[3];
	remote_port[0]=AT24CXX_ReadOneByte(4);
	remote_port[1]=AT24CXX_ReadOneByte(5);
	...
	AT24CXX_Read(10,remoteip,4);
	lwipx->ip[0]=remoteip[0];	
	lwipx->ip[1]=remoteip[1];
	lwipx->ip[2]=remoteip[2];
	lwipx->ip[3]=remoteip[3];
	local_port[0]=AT24CXX_ReadOneByte(14);
	local_port[1]=AT24CXX_ReadOneByte(15);
